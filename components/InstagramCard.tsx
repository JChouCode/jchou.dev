...
const meImages = ['insta.JPG', 'insta2.JPG', 'insta3.JPG', 'insta4.JPG']
const waveImages = ['surf1.jpg', 'surf2.jpg', 'surf4.jpg', 'surf5.jpg', 'surf1.HEIC']
                    ...
                    <div className="relative w-full h-full overflow-hidden">
                        <div className="relative overflow-hidden w-full h-full rounded-xl bg-white">
                            ...
                            <motion.div animate={{ y: hoverY }} transition={{ type: 'spring', duration: 0.7 }} className="z-[100] flex justify-evenly items-center left-0 right-0 backdrop-blur-lg mx-auto bottom-6 absolute w-[150px] h-[48px] bg-white bg-opacity-50 rounded-full border-[#FFFFFF50] border-[3px] ">
                                ...
                                {/* <button onClick={() => { setSelected(Images.ME); }}>
                            <motion.div className="flex justify-center items-center bg-white h-[90%] w-fit px-5 rounded-full" layoutId="selected">
                                <svg width="30px" height="30px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M3 16V8a5 5 0 015-5h8a5 5 0 015 5v8a5 5 0 01-5 5H8a5 5 0 01-5-5z" stroke="#000000" stroke-width="1.5"></path><path d="M16.5 14.5s-1.5 2-4.5 2-4.5-2-4.5-2" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M8.5 10a.5.5 0 110-1 .5.5 0 010 1zM15.5 10a.5.5 0 110-1 .5.5 0 010 1z" fill="#000000" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            </motion.div>
                        </button> */}

...
export default function LinkedInCard() {
    ...
    return (<Card>
        <div className="relative w-full h-full overflow-hidden rounded-2xl p-2 bg-[#F3F2F0]">
            <a href="https://www.linkedin.com/in/jeffreychoucu/" className="z-[1000] absolute flex justify-center items-center right-[28px] top-[28px] h-[50px] w-[50px] rounded-lg overflow-hidden">

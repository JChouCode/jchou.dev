...
export default function ResumeButton() {
    return (<motion.a
        ...
        }} whileTap={{ scale: 0.9 }} href="/resume.pdf" className=" font-[sans-serif] shadow-sm flex justify-center w-[130px] h-[36px] bg-white border-light-gray border-2 rounded-md text-black">

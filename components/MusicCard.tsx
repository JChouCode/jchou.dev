        ...
        <div className="relative p-[28px] h-full overflow-hidden rounded-2xl">
            ...
            <div className=" flex flex-col justify-start">
                ...
                <motion.div animate={{ stroke: playing ? 'white' : 'black', backgroundColor: playing ? '#00000040' : 'white' }} className="z-[200] shadow-sm mt-5 h-[48px] w-full flex justify-between rounded-xl py-[10px] px-[16px] border-black border-2 border-opacity-10">
                    ...
                    <button onClick={() => { audio.pause(); setAudioIndex((prev) => { return prev - 1; }) }}>
                    ...
                    {playing ? <button onClick={() => { audio.pause(); setPlaying(false); }}>
                    ...
                    </button> : <button onClick={() => { audio.play(); setPlaying(true); }}>
                    ...
                    <button onClick={async () => {
                        audio.pause(); await setAudioIndex((prev) => { return prev + 1; });
                    }}>
                    ...
                    {
                        muted ?
                            <button onClick={() => { setMuted(false); audio.muted = false }}>
                            ...
                            <button onClick={() => { setMuted(true); audio.muted = true }}>

        ...
        <div className="w-full mb-6">
            ...
            <div className="flex w-full h-min justify-between items-center">
                <div className="flex flex-col">
                    <h1 className="font-semibold text-[23px] lg:text-[37px] mb-1">
                        Jeffrey Chou
                    </h1>
                    <div className="font-light text-secondary tracking-wide w-fit text-xxs leading-[16px] lg:text-base lg:leading-[25px]">
                        <p>
                            Software engineer from Bay Area, CA.<br></br>{" "}
                            Currently at{" "}
                            <a
                                className="hover:font-regular text-black underline-offset-4 underline"
